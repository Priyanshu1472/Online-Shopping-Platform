...
<html>
<head>
<link rel="stylesheet" href="styles/addpaymentfororder.css">
...
%>
          <tr>
          <th scope="col" style="background-color:grey;"><a href="myCart.jsp"><i class='fas fa-arrow-circle-left'> Back</i></a></th>
            <th scope="col" style="color: white;">Total: <i class="fa fa-inr"></i><%out.println(total); %> </th>
          </tr>
        </thead>
        <thead>
          <tr>
